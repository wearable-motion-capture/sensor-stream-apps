...
class WatchOnlyViaPhoneViewModel(application: Application) :
    AndroidViewModel(application) {

    companion object {
        private const val TAG = "WatchOnlyViaPhone ViewModel"  // for logging
    ...
    fun onServiceUpdate(intent: Intent) {
        // No service updates needed at this state
    }
